...
# 用例编号：TestCase_AcuHMI_003_05_case08
# 用例标题：Post Ch1 enable，HTTP/HTTPS错误配置，Clear Post Channel Logs成功
def test_TestCase_AcuHMI_003_05_case08(login_page: LoginPage):
    login_page.open()
    login_page.login()
