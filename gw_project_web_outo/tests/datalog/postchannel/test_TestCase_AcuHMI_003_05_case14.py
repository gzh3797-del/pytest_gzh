...
# 用例编号：TestCase_AcuHMI_003_05_case14
# 用例标题：Post Ch2 enable，HTTP/HTTPS Yes/Yes/Yes，Test success/fail
@pytest.mark.xfail(strict=False, reason="Test Post Channel结果依赖真实HTTP服务器连通性")
def test_TestCase_AcuHMI_003_05_case14(login_page: LoginPage):
    login_page.open()
    login_page.login()
    page = login_page.page

    _nav_to_post_channel(page, 2)
