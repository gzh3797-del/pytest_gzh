...
# 用例编号：TestCase_AcuHMI_003_05_case06
# 用例标题：Post Ch1 enable，HTTP/HTTPS No/No/No，Test success/fail
@pytest.mark.xfail(strict=False, reason="Test Post Channel结果依赖真实HTTP服务器连通性")
def test_TestCase_AcuHMI_003_05_case06(login_page: LoginPage):
    login_page.open()
    login_page.login()
