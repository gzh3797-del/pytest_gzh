...
# 用例编号: TestCase_AcuRev4100_WEB2_008_003_case01
# 用例标题: 开启SNMP，配置Version为SNMPv2C、端口为161、RO Community与管理端一致
...
def test_TestCase_AcuRev4100_WEB2_008_003_case01(login_page: LoginPage):
    login_page.open()
    login_page.login()
    page = login_page.page
    _nav_protocol(page, "SNMP")

    # 开启 SNMP，配置 Version=v2c, Port=161, Community='public'
