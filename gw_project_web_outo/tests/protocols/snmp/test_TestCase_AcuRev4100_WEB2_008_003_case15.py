...
# 用例编号: TestCase_AcuRev4100_WEB2_008_003_case15
# 用例标题: 开启SNMP，配置Version为SNMPv3、端口为16199、Username和Password、Auth Protocol为SHA、Privacy Protocol为DES和Privacy Password与管理端一致
...
def test_TestCase_AcuRev4100_WEB2_008_003_case15(login_page: LoginPage):
    login_page.open()
    login_page.login()
