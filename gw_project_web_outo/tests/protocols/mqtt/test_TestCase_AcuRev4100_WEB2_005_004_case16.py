...
# 用例编号: TestCase_AcuRev4100_WEB2_005_004_case16
# 用例标题: Interval:消息推送的时间间隔，支持下拉可选1、10、30、60、90、120、180、240、300、480、600秒，遍历所有的时间间隔
...
#   5.Topic输入aaaa
#   6.服务质量选择Qos0
#   7.interval遍历1、10、30、60、90、120、180、240、300、480、600
#   8.查看日志推送时间是否为选择时间
# 预期结果: 8.日志推送时间与选择时间一致
