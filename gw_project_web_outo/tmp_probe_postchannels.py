"""Probe Post Channels page to understand the real UI structure."""
import sys
...
with sync_playwright() as p:
    ...
    page.screenshot(path="screenshots/tmp_postchannels_page.png")
    ...
    for i in range(min(15, form_items.count())):
        txt = form_items.nth(i).inner_text().strip()[:80]
        if txt:
            print(f"  {i}: {txt!r}")
