...
import json
from acudc260_excel_operate import HandleExcel, json_to_dict, OUTPUT_JSON_PATH
...
class MemoryAddr:
    ...
    u_rms_addr = memory_data_dict["readings"].get("V Measured", 0)
    ...
    v1_Comp_rms_addr = memory_data_dict["readings"].get("V1 Compensated", 0)
    v2_Comp_rms_addr = memory_data_dict["readings"].get("V2 Compensated", 0)
