...
运行：
    python projects/RPP/tests/Wiring_check/run_all.py
...
from projects.RPP.tests.Wiring_check.test_3e4wy       import run_all as run_3e4wy,      ALL_TESTS as T_3E4WY
from projects.RPP.tests.Wiring_check.test_2e3w_delta   import run_all as run_delta,       ALL_TESTS as T_DELTA
from projects.RPP.tests.Wiring_check.test_2e3w_network import run_all as run_network,     ALL_TESTS as T_NETWORK
from projects.RPP.tests.Wiring_check.test_2e3w_1phase  import run_all as run_1phase,      ALL_TESTS as T_1PHASE
from projects.RPP.tests.Wiring_check.test_1e2w         import run_all as run_1e2w,        ALL_TESTS as T_1E2W
...
if __name__ == '__main__':
    ...
    print('='*65)
    print(f'报告已输出至：projects/RPP/tests/Wiring_check/reports/')
