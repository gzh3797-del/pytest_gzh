...
格式：TestCase_AcuHMI-1-7_034_<子模块号>_<序号>（与 BACnet 模块 033 同一编号体系）
模块号 034 = 接线检查；子模块号按接线方式划分：
    001=3E4WY, 002=2E3W Delta, 003=2E3W Network, 004=2E3W 1Phase, 005=1E2W
序号在各接线方式内从 001 起。
"""
...
def _tc(sub3: str, seq: int) -> str:
    return f'TestCase_AcuHMI-1-7_{_MODULE}_{_SUB_NUM[sub3]:03d}_{seq:03d}'
