...
> 运行前提：信号源、被测表 Modbus TCP、HMI Web 页面均可达；环境参数在 `projects/RPP/settings.py`。
...
```bash
pytest projects/RPP/tests/Wiring_check/test_3e4wy.py        -v -s   # 3E4WY
pytest projects/RPP/tests/Wiring_check/test_2e3w_delta.py   -v -s   # 2E3W Delta
pytest projects/RPP/tests/Wiring_check/test_2e3w_network.py -v -s   # 2E3W Network
pytest projects/RPP/tests/Wiring_check/test_2e3w_1phase.py  -v -s   # 2E3W 1Phase
pytest projects/RPP/tests/Wiring_check/test_1e2w.py         -v -s   # 1E2W
```
...
```bash
# 单条
pytest projects/RPP/tests/Wiring_check/test_3e4wy.py -k "V-01-ABC" -s

# 多条（或关系）
pytest projects/RPP/tests/Wiring_check/test_3e4wy.py -k "V-01-ABC or I-04-ABC" -s
```
...
```bash
pytest projects/RPP/tests/Wiring_check/test_3e4wy.py --collect-only -q
```
