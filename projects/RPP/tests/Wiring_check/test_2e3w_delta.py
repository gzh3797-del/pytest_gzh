...
运行：
    python projects/RPP/tests/Wiring_check/test_2e3w_delta.py
"""
...
from projects.RPP.tests.Wiring_check.core.expected_engine import compute_2e3w_delta
...
from projects.RPP.tests.Wiring_check.core.tc_map import TC_MAP_DELTA as _TC_MAP
