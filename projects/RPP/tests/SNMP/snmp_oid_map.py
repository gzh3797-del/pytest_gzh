...
# TODO(RPP): 参数描述原取自 AcuHMI_1_7 的 helpers.excel_param_map（Excel Modbus 地址表映射），
#            迁移到 RPP 后暂无等价实现，置空。描述列留空不影响 SNMP↔Modbus 数值比对；
#            后续可指向 RPP 自己的 excel_param_map 恢复参数描述。
_load_excel = None
