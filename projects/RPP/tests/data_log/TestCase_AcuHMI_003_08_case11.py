# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_08_case11
类别：A — Post Historical Data JSON 推送（HTTP，Time Interval Format 文件名）
功能：配置 Post Channel 3（HTTP），JSON 格式，Log File Length=1 hour，Log Interval=10 min，
...
【测试步骤】
  ...
  6. Log File Name Prefix = meter2_logger1
...
CASE_ID = "TestCase_AcuHMI_003_08_case11"
