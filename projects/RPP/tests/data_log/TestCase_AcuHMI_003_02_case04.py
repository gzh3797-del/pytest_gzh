# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_02_case04
类别：C — 正向推送验证
功能：Logger2 通过 FTP 推送 CSV 文件，验证文件到达及格式正确性
...
【预期结果】
  ...
  - 文件名符合格式：meter0_Logger2<YYYYMMDDHHmmss>.csv
...
CASE_ID      = "TestCase_AcuHMI_003_02_case04"
LOGGER_N     = 2
PROTOCOL     = "FTP"
FILE_FORMAT  = "csv"
