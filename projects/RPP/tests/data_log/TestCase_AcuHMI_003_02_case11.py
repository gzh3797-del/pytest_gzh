# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_02_case11
类别：D — 输入校验（Log File Name Prefix 超长）
功能：Logger2 填写超长 Prefix 并保存时，页面应拒绝保存并显示错误提示

【预置条件】
  1. conftest.py driver fixture 已完成网关 Web 登录

【测试步骤】
  1. 进入 Data Loggers 页面，导航到 Logger2 配置
  2. 将 Enable 设为 True
