# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_01_case01
类别：A — Disable 验证
功能：Logger1 处于 Disable 状态时，FTP / SFTP 接收目录不应出现任何文件

【预置条件】
  1. setup_env.py 已在后台运行：FTP / SFTP 服务器已启动，
     Post Channel 1=FTP / 2=SFTP 已配置并 Enabled
  2. conftest.py driver fixture 已完成网关 Web 登录

【测试步骤】
  1. 进入 Data Loggers 页面，将 Logger1 设为 Disable 并保存
...
CASE_ID      = "TestCase_AcuHMI_003_01_case01"
LOGGER_N     = 1
