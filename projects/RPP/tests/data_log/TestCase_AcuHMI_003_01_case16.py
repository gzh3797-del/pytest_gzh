# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_01_case16
类别：C — 正向推送验证
功能：Logger1 通过 FTP 推送 JSON 文件，验证文件到达及格式正确性
...
【预期结果】
  ...
  - 文件名符合格式：meter0_logger1<YYYYMMDDHHmmss>.json
  - 所有记录时间戳为 UTC 秒数格式
...
CASE_ID      = "TestCase_AcuHMI_003_01_case16"
LOGGER_N     = 1
PROTOCOL     = "FTP"
FILE_FORMAT  = "json"
