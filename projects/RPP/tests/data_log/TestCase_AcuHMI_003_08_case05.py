# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_08_case05
类别：A — Post Historical Data CSV 推送（FTP，Log File Length=1 month，interval=1 min）
功能：配置 Post Channel 1（FTP），CSV 格式，Log File Length=1 month，Log Interval=1 min，
...
【预期结果】
  ...
  - Log Interval 约 60 s，Log File Length 约 1 month
"""
from helpers import run_post_historical_case

CASE_ID = "TestCase_AcuHMI_003_08_case05"
