# -*- coding: utf-8 -*-
"""
_src_io_ao.py — AcuIOM-1 "IO → AO" 页面操作

页面结构与 _src_io_ai.py 的 AI 标签同构（同一 <table> 组件），列头替换为
Output Lower Limit / Output Upper Limit；Edit 弹窗 "AO n Details" 内 Breakpoints
列序与 AI **相反**："Eng. Value (x)" -> "Output (V)"（实测确认）。
"""
from __future__ import annotations

from playwright.sync_api import Page

from helpers_iom01 import step  # noqa: F401
