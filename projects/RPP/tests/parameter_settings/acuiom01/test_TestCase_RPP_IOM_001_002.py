# -*- coding: utf-8 -*-
"""
TestCase_RPP_IOM_001_002
模块：IO接入参数设置 → AcuIOM-01 AI设置
标题：AI Signal Type 四种输入类型遍历

步骤：
  1. 进入 IO-AI 标签
  2. AI1 Signal Type 依次设为 Voltage(0-10V)/Voltage(2-10V)/Current(0-20mA)/Current(4-20mA)，每次 Save
  3. 每次经 Modbus 回读 AI1 Type(12288)
  4. 恢复 AI1=Voltage(0-10V) 回读确认

预期：四种类型均保存成功；Modbus 回读编码值与所选一致(0/1/2/3)；还原成功
"""
import sys
import os
...
def test_TestCase_RPP_IOM_001_002(app_page):
