...
备注：TODO(需真机确认) —— 本行内表格无 Edit 弹窗，未见 .el-form-item__error
内联样式，暂以 save_and_check() 返回 False（toast 警告/错误或无成功提示）作为
"被阻止"判据；超上界样例值 999999.999 为占位，请按真机实际量程上限调整。
"""
import sys
import os
...
def test_TestCase_RPP_IOM_006_004(app_page):
