...
备注：TODO(需真机确认) —— 同 006_004，以 save_and_check() 返回 False 作为
"被阻止"判据；超上界样例值 999999 为占位（Pulse Width 为 uint16，真实上限
应 <=65535，请按真机实际量程调整）。
"""
import sys
import os
...
def test_TestCase_RPP_IOM_007_003(app_page):
