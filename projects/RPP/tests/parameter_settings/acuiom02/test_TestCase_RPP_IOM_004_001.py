# -*- coding: utf-8 -*-
"""
TestCase_RPP_IOM_004_001
模块：IO接入参数设置 → AcuIOM-02 AO设置
标题：AO Signal Type 四种输出类型遍历

步骤：
  1. 进入 IO-AO 标签
  2. AO1 Signal Type 依次设四种类型，每次 Save，逐次 Modbus 回读
  3. 恢复 Voltage(0-10V) 回读确认

预期：四种均保存成功，Modbus 回读一致；还原成功
"""
import sys
import os
...
def test_TestCase_RPP_IOM_004_001(app_page):
