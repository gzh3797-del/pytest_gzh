# -*- coding: utf-8 -*-
"""
_src_io_do.py — AcuIOM-3 "IO → DO" 页面操作（2 路 DO）

页面结构与 acuiom04/_src_io_do.py 完全同构（同一前端组件，仅通道数不同：IOM-3 为
2 DO）。列序：checkbox(0) / ID(1,"DO n") / Control Mode(2,el-select，Manual/Pulse) /
Pulse Width(3,input) / Action(4，仅 Copy)。**设备当前离线，conftest 会 pytest.skip。**
"""
from __future__ import annotations

from playwright.sync_api import Page

from helpers_iom03 import step  # noqa: F401
