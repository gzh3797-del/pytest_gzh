...
# 用例编号：Function_RPP_025_001_case1
# 用例标题：接入设备log栏，通过Trend log产生时间区间和间隔(mins)，可采集并显示Realtime log参数趋势折线图(VLN,VLL,I,P,S,PF,FREQ)
# 预置条件：
#   1. RPP 上电
...
def test_Function_RPP_025_001_case1():
    pass
