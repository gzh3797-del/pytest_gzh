...
MODEL_TO_TEMPLATE: dict[str, str] = {
    ...
    # ACM-41-WEB2 Gateway Mode 下挂 IOM（Settings→Devices Model 列原文，实测于
    # https://192.168.3.47），映射到模板名供 find_template_file 在
    # templates/raw 命中 "AcuIOM-0{1..4}_v1.01_20250205.xlsx"。
    "AcuIOM-1":       "AcuIOM01",
    "AcuIOM-2":       "AcuIOM02",
    "AcuIOM-3":       "AcuIOM03",  # 实测该台离线（IOM03P170S04）
    "AcuIOM-4":       "AcuIOM04",
}
