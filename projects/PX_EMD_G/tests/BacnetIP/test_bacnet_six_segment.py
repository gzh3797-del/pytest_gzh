...
运行：
  pytest projects/PX_EMD_G/tests/BacnetIP/test_bacnet_six_segment.py -v
  pytest projects/PX_EMD_G/tests/BacnetIP/ -v   # 与其余 BACnet 用例一起运行
"""
...
from projects.PX_EMD_G.tests.BacnetIP.test_bacnet_ui_protocol import (  # noqa: E402
