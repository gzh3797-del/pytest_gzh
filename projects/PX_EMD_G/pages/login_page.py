...
from projects.PX_EMD_G.settings import DEFAULT_USERNAME, BASE_URL, DEFAULT_PASSWORD
from projects.PX_EMD_G.pages.base_page import BasePage
...
class LoginPage(BasePage):
    ...
    def is_logged_in(self) -> bool:
        # PX-EMD-G 顶部产品菜单出现即表示登录成功
        return self.page.locator("header span").filter(has_text="PX-EMD-G").first.is_visible()
