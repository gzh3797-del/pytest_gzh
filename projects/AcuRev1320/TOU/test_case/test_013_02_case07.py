...
"""
Function_AcuRev1320_013_02_case7
    配置tariff 分别为sharp、peak、valley、normal并update，检查創建segment ID時候，分別只能选择sharp、peak、valley、normal
"""
...
def test_013_02_case7():
    ...
    check_tariff_0 = tou.check_segment_tariff(segment_tariff=1)
    assert check_tariff_0
