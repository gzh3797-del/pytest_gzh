...
"""
    Special Weekday Schedule栏，已存在season ID1配置Schedule ID2(勾选Mon、Tue、Wed、Thu、Fri、Sat Sun，Sat）可配置成功，
    特殊周休配置开关开启和关闭正常
    
    1、连接AcuRev1320电表到Acuview2上，连接状态为connected。
    2、Special Weekday Schedule栏，已存在season1配置Schedule2(勾选Mon、Tue、Wed、Thu、Fri、Sat Sun，Sat）
...
def test_013_03_case1():
    ...
    tou.tou_seasons_add(session_id=1, seasons_schedule_id=[2])
    ...
    tou.tou_special_weekday_schedule_add(session_id=1,
                                         ...
                                         weekend_schedule=[[2, 2, 2, 2, 2, 2, 2]])
