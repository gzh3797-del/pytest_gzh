...
def test_013_02_case6():
    # 上位机TOU Setting页面设置billing_and_tariff
    tou.billing_and_tariff_Setting(billing_mode=0, at_time='01 00:30:00', tariff=0)
    ...
    check_tariff_0 = tou.check_segment_tariff(segment_tariff=0)
