...
from projects.AcuvimSeries.memory_info import MemoryAddr
from projects.AcuvimSeries.test_report_table_heading import TableTitle
...
class EnergyMeasure:
    ...
    def get_energy_of_imp_and_exp(test_time, phase_power):
        ...
        if phase_power:
            ...
            energy_exp = phase_power * test_time
