r"""Function_AC meter_004_01_case20
用例标题: CT选型100mA(1500A)，3E4WY，CT一次侧额定电流取5-2000A范围内任意值1500A，三路显示电流均为750A，测量Ia,Ib,Ic,Iavg满足精度0.2%
预置条件: 1、Acuview2上位机
2、RTU串口线
3、AcuRev-100电表
4、接线方式3E4WY
测试步骤: 1、连接AcuRev-100电表到Acuview2上，链接状态为connected
2、上位机配置CT Type=100mA、CT Primary=1500（范围内任意非档位值）
3、源输入三路电流均为10A（经台体CT 20A/100mA，显示系数=Primary/20=75，对应显示750A），分别配置为对应A相、B相、C相
...
def test_004_01_case20():
    report = run_accuracy_case(case_meta={
        '编号': 'Function_AC meter_004_01_case20',
        '标题': 'CT选型100mA(1500A)，3E4WY，CT一次侧额定电流取5-2000A范围内任意值1500A，三路显示电流均为750A，测量Ia,Ib,Ic,Iavg满足精度0.2%',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表\n4、接线方式3E4WY',
        '测试步骤': '1、连接AcuRev-100电表到Acuview2上，链接状态为connected\n2、上位机配置CT Type=100mA、CT Primary=1500（范围内任意非档位值）\n3、源输入三路电流均为10A（经台体CT 20A/100mA，显示系数=Primary/20=75，对应显示750A），分别配置为对应A相、B相、C相\n4、Acuview2上检查Ia、Ib、Ic、Iavg是否均在精度范围内\n5、恢复CT Primary=1000（默认值）',
        '预期结果': '4、Acuview2上检查交流电相电流均在精度范围内\nIa：748.5 ~ 751.5\nIb：748.5 ~ 751.5\nIc：748.5 ~ 751.5\nIavg：748.5 ~ 751.5\n5、回读CT Primary=1000，还原成功',
