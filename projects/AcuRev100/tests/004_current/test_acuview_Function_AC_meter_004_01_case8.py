r"""Function_AC meter_004_01_case8
用例标题: CT选型100mA(200A)，3E4WY，三路电流分别为(50A、100A，200A)，在上位机上分别配置为对应A相、B相、C相，测量Ia,Ib,Ic,Iavg满足精度0.2%
预置条件: 1、Acuview2上位机
2、RTU串口线
3、AcuRev-100电表
4、接线方式3E4WY
测试步骤: 1、连接AcuRev-100电表到Acuview2上，链接状态为connected
2、输入三路电流分别为(5A、10A，20A)，在上位机上分别配置为对应A相、B相、C相
...
def test_004_01_case8():
    report = run_accuracy_case(case_meta={
        '编号': 'Function_AC meter_004_01_case8',
        '标题': 'CT选型100mA(200A)，3E4WY，三路电流分别为(50A、100A，200A)，在上位机上分别配置为对应A相、B相、C相，测量Ia,Ib,Ic,Iavg满足精度0.2%',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表\n4、接线方式3E4WY',
        '测试步骤': '1、连接AcuRev-100电表到Acuview2上，链接状态为connected\n2、输入三路电流分别为(5A、10A，20A)，在上位机上分别配置为对应A相、B相、C相\n3、Acuview2上检查交流电相电流是否均在精度范围内',
        '预期结果': '3、Acuview2上检查交流电相电流均在精度范围内\nIa：\t49.900\t~\t50.100\nIb:\t99.800\t~\t100.200\nIc:\t199.600\t~\t200.400\nIavg:\t116.433\t~\t116.900',
