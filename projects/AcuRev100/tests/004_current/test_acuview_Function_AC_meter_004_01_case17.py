r"""Function_AC meter_004_01_case17
用例标题: CT选型RCT(1000A)，3E4WY，输入三路电流分别为(400A、600A，800A)，在上位机上分别配置为对应A相、B相、C相，测量Ia,Ib,Ic,Iavg满足精度0.2%
预置条件: 1、Acuview2上位机
2、RTU串口线
3、AcuRev-100电表
4、接线方式3E4WY
测试步骤: 1、连接AcuRev-100电表到Acuview2上，链接状态为connected
2、输入三路电流分别为(2A、3A，4A)，在上位机上分别配置为对应A相、B相、C相
3、Acuview2上检查交流电相电流是否均在精度范围内
预期结果: 3、Acuview2上检查交流电相电流均在精度范围内
Ia：	399.200	~	400.800
Ib:	598.800	~	601.200
Ic:	798.400	~	801.600
Iavg:	598.800	~	601.200
...
def test_004_01_case17():
    report = run_accuracy_case(case_meta={
        '编号': 'Function_AC meter_004_01_case17',
        '标题': 'CT选型RCT(1000A)，3E4WY，输入三路电流分别为(400A、600A，800A)，在上位机上分别配置为对应A相、B相、C相，测量Ia,Ib,Ic,Iavg满足精度0.2%',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表\n4、接线方式3E4WY',
        '测试步骤': '1、连接AcuRev-100电表到Acuview2上，链接状态为connected\n2、输入三路电流分别为(2A、3A，4A)，在上位机上分别配置为对应A相、B相、C相\n3、Acuview2上检查交流电相电流是否均在精度范围内',
        '预期结果': '3、Acuview2上检查交流电相电流均在精度范围内\nIa：\t399.200\t~\t400.800\nIb:\t598.800\t~\t601.200\nIc:\t798.400\t~\t801.600\nIavg:\t598.800\t~\t601.200',
