r"""Function_AC meter_004_01_case15
用例标题: CT选型100mA(1200A)，三路电流分别为（12，12，12）,在上位机上分别配置为对应A相、B相、C相，精度保证的电流范围0.2%,输入三路电流分别为（1.2A，1.2A，1.2A）
备注：0.8A为Ist
预置条件: 1、Acuview2上位机
2、RTU串口线
3、AcuRev-100电表
...
Ic:	11.976	~	12.024
Iavg:	11.976	~	12.024
4、Acuview2上检查交流电相电流分别为：（1.2A，1.2A，1.2A）(无精度要求)
...
def test_004_01_case15():
    report = run_accuracy_case(case_meta={
        '编号': 'Function_AC meter_004_01_case15',
        '标题': 'CT选型100mA(1200A)，三路电流分别为（12，12，12）,在上位机上分别配置为对应A相、B相、C相，精度保证的电流范围0.2%,输入三路电流分别为（1.2A，1.2A，1.2A）\n备注：0.8A为Ist',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表\n4、接线方式3E4WY',
        '测试步骤': '1、连接AcuRev-100电表到Acuview2上，链接状态为connected\n2、输入三路电流分别为（0.2，0.2，0.2）,在上位机上分别配置为对应A相、B相、C相。\n3、精度保证的电流范围是否符合精度要求\n4、源输入电流A\\B\\C三相分别为（0.02，0，0.02）',
        '预期结果': '3、Acuview2上检查交流电相电流均在精度范围内\nIa：\t11.976\t~\t12.024\nIb:\t11.976\t~\t12.024\nIc:\t11.976\t~\t12.024\nIavg:\t11.976\t~\t12.024\n4、Acuview2上检查交流电相电流分别为：（1.2A，1.2A，1.2A）(无精度要求)',
