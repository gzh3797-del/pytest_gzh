r"""Function_AC meter_011_01_case10
用例标题: 铅封未封闭，上位机上用户可重置这些设备运行时间
预置条件: 1、Acuview2上位机 / 2、RTU串口线 / 3、AcuRev-100电表
测试步骤: 2、上位机(等效Modbus)重置设备运行时间
3、读回≈0
预期结果: 运行时间被清除(读值≤10s); HMI显示0H为MANUAL目视
...
def test_011_01_case10():
    report = run_timing_case(case_meta={
        '编号': 'Function_AC meter_011_01_case10',
        '标题': '铅封未封闭，上位机上用户可重置这些设备运行时间',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表',
        '测试步骤': '2、上位机(等效Modbus)重置设备运行时间\n3、读回≈0',
        '预期结果': '运行时间被清除(读值≤10s); HMI显示0H为MANUAL目视',
