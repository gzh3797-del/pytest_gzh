r"""Function_AC meter_002_01_case1
用例标题: 交流电Van、Vbn、Vcn输入额定电压分别均为120V,测量Van、Vbn、Vcn、Vlnavg满足精度要求0.2%
预置条件: 1、Acuview2上位机
2、RTU串口线
3、AcuRev-100电表
...
预期结果: 3、Acuview2上检查交流电相电压均在精度范围内，范围(V):119.760 ~ 120.240
...
def test_002_01_case1():
    report = run_accuracy_case(case_meta={
        '编号': 'Function_AC meter_002_01_case1',
        '标题': '交流电Van、Vbn、Vcn输入额定电压分别均为120V,测量Van、Vbn、Vcn、Vlnavg满足精度要求0.2%',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表',
        '测试步骤': '1、连接AcuRev-100电表到Acuview2上，链接状态为connected\n2、交流电源输入相电压Van、Vbn、Vcn的额定电压为120V。\n3、Acuview2上检查交流电相电压是否均在精度范围内',
        '预期结果': '3、Acuview2上检查交流电相电压均在精度范围内，范围(V):119.760 ~ 120.240\nVlnavg范围(V)：119.760 ~ 120.240',
