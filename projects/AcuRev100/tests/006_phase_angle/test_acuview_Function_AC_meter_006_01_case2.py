r"""Function_AC meter_006_01_case2
用例标题: ABC三相电压角度为(0°  1°  5°)，上位机上检查phaseA、phaseB、PhaseC的相角满足精度±0.5°
预置条件: 1、Acuview2上位机 / 2、RTU串口线 / 3、AcuRev-100电表
测试步骤: 1、连接AcuRev-100电表到Acuview2上，链接状态为connected
2、电源输入ABC三相电压角度为(0°  1°  5°)，电压为100V
...
def test_006_01_case2():
    report = run_accuracy_case(case_meta={
        '编号': 'Function_AC meter_006_01_case2',
        '标题': 'ABC三相电压角度为(0°  1°  5°)，上位机上检查phaseA、phaseB、PhaseC的相角满足精度±0.5°',
        '预置条件': '1、Acuview2上位机\n2、RTU串口线\n3、AcuRev-100电表',
        '测试步骤': '1、连接AcuRev-100电表到Acuview2上，链接状态为connected\n2、电源输入ABC三相电压角度为(0°  1°  5°)，电压为100V\n3、检查相电压A B C三相的精度是否符合±0.5°',
        '预期结果': '3、检查相电压A B C三相的精度符合±0.5°(判据=设定值±0.5°)',
