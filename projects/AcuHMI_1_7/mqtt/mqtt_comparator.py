...
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "tools" / "Protocols"))  # tools/Protocols/
...
def start_embedded_broker(
    ...
    threading.Thread(target=lambda: asyncio.run(_coro()), daemon=True).start()
