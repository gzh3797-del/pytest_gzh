# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_04_case08
类别：C — 正向推送验证（快速间隔 20 s）
功能：Rapid Logger 以 20 秒间隔通过 FTP 推送 CSV，验证文件内容及推送频率
...
【预置条件】
  ...
  4. 所有 Physical Devices 的 Poll Interval 须 ≤ 20s（本用例自动设置并还原）
