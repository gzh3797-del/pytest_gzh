# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_02_case13
类别：E — Log Interval 联动验证
功能：Logger2 中，切换 Log File Length 时，Log Interval 下拉选项应与规格一一对应

【预置条件】
  1. conftest.py driver fixture 已完成网关 Web 登录

【测试步骤】
  依次将 Logger2 的 Log File Length 设为以下各值，每次读取 Log Interval 下拉选项并与期望值比对：
...
CASE_ID  = "TestCase_AcuHMI_003_02_case13"
LOGGER_N = 2
