# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_08_case10
类别：A — Post Historical Data JSON 推送（SFTP，Time Interval Format 文件名）
功能：配置 Post Channel 2（SFTP），JSON 格式，Log File Length=30 min，Log Interval=5 min，
...
【测试步骤】
  ...
  6. Log File Name Prefix = meter1_logger1
  7. Log File Length = 30 minutes
  8. Log Interval = 5 minutes
...
CASE_ID = "TestCase_AcuHMI_003_08_case10"
