# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_02_case05
类别：C — 正向推送验证
功能：Logger2 通过 SFTP 推送 CSV 文件，验证文件到达及格式正确性
...
【预期结果】
  ...
  - 文件名符合 Time Interval Format（meter1_Logger2<start><end>.csv）
  - 所有时间戳列为 UTC 秒数格式
...
CASE_ID      = "TestCase_AcuHMI_003_02_case05"
LOGGER_N     = 2
PROTOCOL     = "SFTP"
FILE_FORMAT  = "csv"
