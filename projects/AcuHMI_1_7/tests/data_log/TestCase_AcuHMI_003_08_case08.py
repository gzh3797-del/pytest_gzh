# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_08_case08
类别：A — Post Historical Data CSV 推送（FTP，Log File Length=1 month，interval=1 month）
功能：配置 Post Channel 1（FTP），CSV 格式，Log File Length=1 month，Log Interval=1 month，
...
【预期结果】
  ...
  - 文件行数约为 1（length = interval = 1 month）
"""
from helpers import run_post_historical_case

CASE_ID = "TestCase_AcuHMI_003_08_case08"
