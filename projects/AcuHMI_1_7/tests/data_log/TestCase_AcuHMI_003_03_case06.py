# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_03_case06
类别：C — 正向推送验证
功能：Logger3 通过 HTTP 推送 CSV 文件，验证文件到达及格式正确性
...
【预期结果】
  ...
  - 文件名符合 Time Interval Format（meter2_Logger3<start><end>.csv）
  - 所有时间戳列符合 ISO8601 格式
...
CASE_ID     = "TestCase_AcuHMI_003_03_case06"
LOGGER_N    = 3
PROTOCOL    = "HTTP"
FILE_FORMAT = "csv"
