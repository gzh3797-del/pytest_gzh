# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_03_case10
类别：C — 正向推送验证
功能：Logger3 通过 HTTP 推送 JSON 文件，验证文件到达及格式正确性
...
【测试步骤】
  ...
  3. 验证文件扩展名为 .json
  4. 验证文件名格式：meter2_Logger3 + 开始时间戳 + 结束时间戳（Time Interval Format）
