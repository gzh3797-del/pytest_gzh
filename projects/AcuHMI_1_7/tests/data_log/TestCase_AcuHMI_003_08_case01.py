# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_08_case01
类别：A — Post Historical Data CSV 推送（FTP，Local Time String + UTC Timestamp）
功能：配置 Post Channel 1（FTP），CSV 格式，Log File Length=1 min，Log Interval=1 min，
...
CASE_ID = "TestCase_AcuHMI_003_08_case01"
