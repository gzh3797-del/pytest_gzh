# -*- coding: utf-8 -*-
"""
用例 ID：TestCase_AcuHMI_003_02_case06
类别：C — 正向推送验证
功能：Logger2 通过 HTTP 推送 CSV 文件，验证文件到达及格式正确性
...
【测试步骤】
  ...
  8. 将 Logger2 设为 Disable

【预期结果】
  - HTTP 接收目录内收到至少一个 .csv 文件
  - 文件名符合 Time Interval Format（meter2_Logger2<start><end>.csv）
  - 所有时间戳列符合 ISO8601 格式
...
CASE_ID      = "TestCase_AcuHMI_003_02_case06"
LOGGER_N     = 2
PROTOCOL     = "HTTP"
FILE_FORMAT  = "csv"
