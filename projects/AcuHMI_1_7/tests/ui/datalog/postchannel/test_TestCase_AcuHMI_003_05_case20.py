...
# 用例编号：TestCase_AcuHMI_003_05_case20
# 用例标题：Post Ch3 enable，HTTP/HTTPS Yes/Yes/Yes，Test success/fail
@pytest.mark.xfail(strict=False, reason="Test Post Channel结果依赖真实HTTP服务器连通性")
def test_TestCase_AcuHMI_003_05_case20(login_page: LoginPage):
    login_page.open()
    login_page.login()
