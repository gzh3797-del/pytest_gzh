...
_ROLE_NAME = "pp02_4role"
_USER_NAME = "pp02_4user"
_PWD_0     = "Admin@11001"
_PWD_1     = "Admin@22002"
_PWD_2     = "Admin@33003"
...
# 用例编号：TestCase_AcuHMI_007_03_case02_4
# 用例标题：设置密码历史记录为 32（最大值），复用历史密码设置失败，使用新密码设置成功
# 测试步骤：
#   1. Password History = 32，点击 Save
#   2. 创建用户 P0，管理员改密到 P1
#   3. 尝试将密码改回 P0（历史中）→ 失败
#   4. 将密码改为 P2（新密码）→ 成功
#   5. 用 P2 登录
...
#   4. 设置成功
#   5. 登录成功
def test_TestCase_AcuHMI_007_03_case02_4(login_page: LoginPage):
    login_page.open()
    login_page.login()
