...
_ROLE_NAME   = "pp03_4role"
_USER_NAME   = "pp03_4user"
_PWD_0       = "Admin@11001"
_PWD_1       = "Admin@22002"
_MIN_AGE     = 90
...
# 简化说明：无需真等 90 天——刚创建的用户密码"年龄"为 0 天，处于 90 天最短期限窗口内，
#           此刻自助修改应被策略拒绝。以"第 0 天立即修改被拒"等价验证"90 天内不允许修改"。
#           （与 case03_2 同套路，仅 Minimum Password Age 由 1 改为 90）
# 测试步骤：
#   1. Minimum Password Age = 90，保存
#   2. 创建新用户，密码为 P0
#   3. 用户立即（远不到 90 天）尝试自助修改密码
# 预期结果：
