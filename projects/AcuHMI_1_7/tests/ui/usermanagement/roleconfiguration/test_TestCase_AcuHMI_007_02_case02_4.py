...
_ROLE_NAME = "rc02_4edit2none"
_USER_NAME = "rcuser02_4"
...
# 用例编号：TestCase_AcuHMI_007_02_case02_4
# 用例标题：编辑角色，由角色权限全编辑改为全无，创建该用户，登录后查看该用户权限
...
def test_TestCase_AcuHMI_007_02_case02_4(login_page: LoginPage):
    login_page.open()
    login_page.login()
