"""
FTS编号: FTS_AcuHMI_AZR_004_006
用例标题: AcuHMI-1-7选择AcuRev1300设备连接 Azure IoT Hub 数据上报（三段式比较）
用例级别: LV1

预置条件:
  - AcuRev1300 设备已接入网关并在线，合法 Connection String 已配置

测试步骤:
  1. 仅勾选 AcuRev1300 设备，Parameter Type=AI，Parameter=ALL
...
DEVICE_NAME      = "AcuRev1300"
EXPECTED_DEVICES = ["AcuRev1300"]


class TestCase_AcuHMI_1_7_AZR_004_006:

    @pytest.mark.azure_iot
    @pytest.mark.slow
    def test_acurev1300_connect_and_verify(self, azure_page, azure_cfg):
        """配置 AcuRev1300 → Test Connection → 三段式验证"""
