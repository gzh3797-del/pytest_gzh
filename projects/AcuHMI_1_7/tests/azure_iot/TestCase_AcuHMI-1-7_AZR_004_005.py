"""
FTS编号: FTS_AcuHMI_AZR_004_005
用例标题: AcuHMI-1-7选择AcuvimIIW设备连接 Azure IoT Hub 数据上报（三段式比较）
用例级别: LV1

预置条件:
  - AcuvimIIW 设备已接入网关并在线，合法 Connection String 已配置
...
class TestCase_AcuHMI_1_7_AZR_004_005:

    @pytest.mark.azure_iot
    @pytest.mark.slow
    def test_acuvim_iiw_connect_and_verify(self, azure_page, azure_cfg):
        """配置 AcuvimIIW → Test Connection → 三段式验证"""
