"""
FTS编号: FTS_AcuHMI_AZR_004_001
用例标题: AcuHMI-1-7选择AcuRev4100设备连接 Azure IoT Hub 数据上报（三段式比较）
用例级别: LV1

预置条件:
  - AcuRev4100 设备已接入网关并在线，合法 Connection String 已配置

测试步骤:
  1. 仅勾选 AcuRev4100 设备，Parameter Type=AI，Parameter=ALL
...
DEVICE_NAME      = "4100"
EXPECTED_DEVICES = ["4100242", "Acu4100"]


class TestCase_AcuHMI_1_7_AZR_004_001:

    @pytest.mark.azure_iot
    @pytest.mark.slow
    def test_acurev4100_connect_and_verify(self, azure_page, azure_cfg):
        """配置 AcuRev4100 → Test Connection → 三段式验证"""
