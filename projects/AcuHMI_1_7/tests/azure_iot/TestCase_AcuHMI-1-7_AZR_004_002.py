"""
FTS编号: FTS_AcuHMI_AZR_004_002
用例标题: AcuHMI-1-7选择AcuRev2100设备连接 Azure IoT Hub 数据上报（三段式比较）
用例级别: LV1

预置条件:
  - AcuRev2100 设备已接入网关并在线，合法 Connection String 已配置

测试步骤:
  1. 仅勾选 AcuRev2100 设备，Parameter Type=AI，Parameter=ALL
...
EXPECTED_DEVICES = ["AcuRev2100"]


class TestCase_AcuHMI_1_7_AZR_004_002:

    @pytest.mark.azure_iot
    @pytest.mark.slow
    def test_acurev2100_connect_and_verify(self, azure_page, azure_cfg):
        """配置 AcuRev2100 → Test Connection → 三段式验证"""
