...
pytest projects/AcuHMI_1_7/tests/BacnetIP/ -v --html=reports/bacnet_ui.html --self-contained-html

# 只跑 P0 参数列表一致性（纯 UI，无 BACnet 客户端）
pytest projects/AcuHMI_1_7/tests/BacnetIP/test_bacnet_ui_basic.py -v --html=reports/bacnet_ui.html --self-contained-html

# 只跑 P1/P2 配置页面功能（纯 UI，无 BACnet 客户端）
pytest projects/AcuHMI_1_7/tests/BacnetIP/test_bacnet_ui_config.py -v --html=reports/bacnet_ui.html --self-contained-html

# 只跑协议端到端验证（需 BACnet 客户端连接，须串行执行勿加 -n）
pytest projects/AcuHMI_1_7/tests/BacnetIP/test_bacnet_ui_protocol.py -v --html=reports/bacnet_ui.html --self-contained-html

# 只跑协议元数据/合规/稳定性 050–054（需 BACnet 客户端，须串行执行勿加 -n）
pytest projects/AcuHMI_1_7/tests/BacnetIP/test_bacnet_six_segment.py -v --html=reports/bacnet_ui.html --self-contained-html

# 单跑 six_segment 中较快的 052/053/054（探针单个 AI 对象；050 需读全量对象，耗时长）
pytest projects/AcuHMI_1_7/tests/BacnetIP/test_bacnet_six_segment.py -k "052 or 053 or 054" -v --html=reports/bacnet_ui.html --self-contained-html

# 单条用例（-k 关键词过滤）
pytest projects/AcuHMI_1_7/tests/BacnetIP/ -k "test_013" -v --html=reports/bacnet_ui.html --self-contained-html

# 跳过需要 BACnet 客户端的协议用例（纯 UI 回归）
pytest projects/AcuHMI_1_7/tests/BacnetIP/ --ignore=projects/AcuHMI_1_7/tests/BacnetIP/test_bacnet_ui_protocol.py -v --html=reports/bacnet_ui.html --self-contained-html
```
