...
配置统一从 projects/acuhmi_1_7/settings.py 读取，支持 WEB2 / HMI17 一键切换。
"""
import sys
...
# ── 确保仓库根目录在 sys.path，可 import projects.acuhmi_1_7.settings ──────────
_REPO_ROOT = Path(__file__).resolve().parents[4]
if str(_REPO_ROOT) not in sys.path:
    sys.path.insert(0, str(_REPO_ROOT))

import projects.AcuHMI_1_7.settings as _cfg
