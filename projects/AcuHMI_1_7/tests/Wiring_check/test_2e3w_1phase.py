"""
2E3W 1Phase 接线检查自动化测试（HMI1-7）

运行：
    python projects/AcuHMI_1_7/tests/Wiring_check/test_2e3w_1phase.py
"""
...
from projects.AcuHMI_1_7.tests.Wiring_check.core.expected_engine import compute_2e3w_1phase
...
from projects.AcuHMI_1_7.tests.Wiring_check.core.tc_map import TC_MAP_1PHASE as _TC_MAP
