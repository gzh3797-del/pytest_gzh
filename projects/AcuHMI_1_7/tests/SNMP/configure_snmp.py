...
try:
    from projects.AcuHMI_1_7.settings import BASE_URL, DEFAULT_USERNAME as USERNAME, DEFAULT_PASSWORD as PASSWORD
except ImportError:
...
def login_and_goto_snmp(page: Page) -> None:
    ...
    if cancel_btn:
        ...
        log.info("[Browser] 关闭弹窗")

    nav_menus = page.query_selector_all(".nav-item-menu")
    nav_menus[2].click()
    page.wait_for_timeout(1500)
    page.click("text=Protocols")
    page.wait_for_timeout(800)
    page.click("text=SNMP")
...
def goto_snmp(page: Page) -> None:
    ...
    try:
        ...
        pass
    try:
        page.click("text=Protocols", timeout=3000)
        page.wait_for_timeout(500)
    except Exception:
        pass
    page.click("text=SNMP", timeout=5000)
