...
运行：
    python projects/AcuHMI_1_7/tests/wiring_check/run_all.py
...
from projects.AcuHMI_1_7.tests.wiring_check.test_3e4wy       import run_all as run_3e4wy,      ALL_TESTS as T_3E4WY
from projects.AcuHMI_1_7.tests.wiring_check.test_2e3w_delta   import run_all as run_delta,       ALL_TESTS as T_DELTA
from projects.AcuHMI_1_7.tests.wiring_check.test_2e3w_network import run_all as run_network,     ALL_TESTS as T_NETWORK
from projects.AcuHMI_1_7.tests.wiring_check.test_2e3w_1phase  import run_all as run_1phase,      ALL_TESTS as T_1PHASE
from projects.AcuHMI_1_7.tests.wiring_check.test_1e2w         import run_all as run_1e2w,        ALL_TESTS as T_1E2W
...
if __name__ == '__main__':
    ...
    print('='*65)
    print(f'报告已输出至：projects/AcuHMI_1_7/tests/wiring_check/reports/')
