...
运行：
    python projects/AcuHMI_1_7/tests/wiring_check/test_3e4wy.py
"""
import sys
import os
import logging
...
from projects.AcuHMI_1_7.tests.wiring_check.core.expected_engine import compute_3e4wy
...
from projects.AcuHMI_1_7.tests.wiring_check.core.tc_map import TC_MAP_3E4WY as _TC_MAP
...
DEVICE_NAME = cfg.HMI_DEVICE_NAME
