...
def write_excel_topic():
    ...
    topic_list = ['测试用例', 'A相电压输入值', 'B相电压输入值', 'C相电压输入值', 'A相电流输入值', 'B相电流输入值',
                  'C相电流输入值', 'A相电压相位输入值', 'B相电压相位输入值', 'C相电压相位输入值',
                  'A相电流相位输入值', 'B相电流相位输入值', 'C相电流相位输入值', 'A相有功功率输入值',
                  'B相有功功率输入值', 'C相有功功率输入值', 'A相无功功率输入值', 'B相无功功率输入值',
                  'C相无功功率输入值',
                  'A相视在功率输入值', 'B相视在功率输入值', 'C相视在功率输入值',
                  'A相进线有功能量输入值', 'A相出线有功能量输入值', 'B相进线有功能量输入值',
                  'B相出线有功能量输入值',
                  'C相进线有功能量输入值', 'C相出线有功能量输入值',
                  'A相进线无功能量输入值', 'A相出线无功能量输入值', 'B相进线无功能量输入值',
                  'B相出线无功能量输入值',
                  'C相进线无功能量输入值', 'C相出线无功能量输入值',
                  'A相进线视在能量输入值', 'A相出线视在能量输入值', 'B相进线视在能量输入值',
                  'B相出线视在能量输入值',
                  'C相进线视在能量输入值', 'C相出线视在能量输入值',
                  'A相进线有功能量测量值', 'A相出线有功能量测量值', 'B相进线有功能量测量值',
                  'B相出线有功能量测量值',
                  'C相进线有功能量测量值', 'C相出线有功能量测量值',
                  'A相进线无功能量测量值', 'A相出线无功能量测量值', 'B相进线无功能量测量值',
                  'B相出线无功能量测量值',
                  'C相进线无功能量测量值', 'C相出线无功能量测量值',
                  'A相进线视在能量测量值', 'A相出线视在能量测量值', 'B相进线视在能量测量值',
                  'B相出线视在能量测量值',
                  'C相进线视在能量测量值', 'C相出线视在能量测量值',
                  'A相进线有功能量精度', 'A相出线有功能量精度', 'B相进线有功能量精度', 'B相出线有功能量精度',
