...
python Protocols/IoT/AWS_IoT/aws_iot_verifier.py --timeout 120 --no-web

# 指定配置文件
python Protocols/IoT/AWS_IoT/aws_iot_verifier.py --config Protocols/IoT/AWS_IoT/config.yaml --timeout 120
```
...
aws_iot:
  ...
  cert_file: "Protocols/IoT/AWS_IoT/certs/client.pem"       # 配置页上传用证书
  key_file:  "Protocols/IoT/AWS_IoT/certs/key.pem"          # 配置页上传用私钥
  ca_file:   "Protocols/IoT/AWS_IoT/certs/AmazonRootCA1.pem"# 验证脚本订阅用 CA
  sub_cert_file: "Protocols/IoT/AWS_IoT/certs/<hash>-certificate.pem.crt"  # 验证脚本订阅用证书
  sub_key_file:  "Protocols/IoT/AWS_IoT/certs/<hash>-private.pem.key"      # 验证脚本订阅用私钥
...
python Protocols/IoT/Azure_IoT/azure_iot_verifier.py --timeout 120 --no-web

# 指定配置文件
python Protocols/IoT/Azure_IoT/azure_iot_verifier.py --config Protocols/IoT/Azure_IoT/config.yaml --timeout 120
```
