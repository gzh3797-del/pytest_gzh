...
from test_case.AcuHMI_1_7.wiring_check.core.expected_engine import compute_2e3w_delta
...
from test_case.AcuHMI_1_7.wiring_check.core.tc_map import TC_MAP_DELTA as _TC_MAP
