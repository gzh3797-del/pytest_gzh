...
"""
Function_AcuRev1320_013_02_case9
    删除2个Segment(3个)，update 更新保存正常
"""
...
def test_013_02_case5_1():
    ...
    # 配置1个Schedule Id，Schedule ID对应配置3个segment ID
    tou.tou_schedules_add(schedule_id=1, segment_id=3, segment_tariff=segment_tariff, segment_time=segment_time)
    ...
    tou.tou_segment_remove(number=2)
    update_success = tou.click_update()
    assert update_success
    segments = tou.check_number_of_segments(number=1)
    assert segments
