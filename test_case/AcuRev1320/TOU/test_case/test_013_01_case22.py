...
"""
Function_AcuRev1320_013_01_case22
"""

dst_format = 2
(start_month, start_day, start_week, start_time, start_adjust_time) = (1, 1, 6, '02:00', 60)
(end_month, end_day, end_week, end_time, end_adjust_time) = (2, 5, 5, '03:00', 60)
(end_month2, end_day2, end_week2, end_time2, end_adjust_time2) = (7, 1, 2, '03:00', 60)
time_year, time_month, time_day, time_hour, time_minute, time_second = 2024, 2, 29, 2, 59, 55
