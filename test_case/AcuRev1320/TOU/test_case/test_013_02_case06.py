...
"""
    Function_AcuRev1320_013_02_case6
    删除一个2个TOU Schedule(3个)，update 更新保存正常
...
def test_013_02_case5_1():
    ...
    tou.tou_schedules_add(schedule_id=3, segment_id=1, segment_tariff=segment_tariff, segment_time=segment_time)
    ...
    # 上位机上删除一个schedules
    tou.tou_schedules_remove(number=2)
    update_success = tou.click_update()
    assert update_success
