...
from test_case.ACM_41_WEB2.wiring_check.core.expected_engine import compute_1e2w
...
from test_case.ACM_41_WEB2.wiring_check.core.tc_map import TC_MAP_1E2W as _TC_MAP
from test_case.ACM_41_WEB2.wiring_check.test_3e4wy import (
...
# 用例 → 接线检测总表_ver1.05.xlsx 行号对照（Sheet: 1LN(1E2W)）
_SPEC_REFS = {
    'PASS': '—',
    'V-01': '1LN(1E2W), 行2',
    'I-01': '1LN(1E2W), 行3',
...
def run_all(tests=ALL_TESTS, headless=False):
    ...
    try:
        ...
        path = rpt.generate(results, '1E2W', DEVICE_NAME, cfg.METER_TCP_IP, active_channels=cfg.ACTIVE_USER_CHANNELS[cfg.SERVICE_1E2W], channel_phases=cfg.CHANNEL_PHASES[cfg.SERVICE_1E2W])
        print(f'报告：{path}')
        return results
