...
TC_MAP_3E4WY: dict[str, str] = {
    ...
    'I-08-ACB':  _tc('3E4', 30),
    'I-09-ACB':  _tc('3E4', 31),
    # 条件2/3/4 guard 负向用例（Vcn/Van/Vbn 偏低，guard 不成立，落入条件7/5/6）
...
TC_MAP_DELTA: dict[str, str] = {
    ...
    'V-05-REG':  _tc('DLT', 22),
    'V-06-REG':  _tc('DLT', 23),
    # 条件7 无法构造单侧回归，见 test_2e3w_delta.py 注释
}

# ── 2E3W Network（test_2e3w_network.py，算法同 3E4WY，子模块编号不同）───────────
TC_MAP_NET: dict[str, str] = {
    ...
    'I-08-ACB':  _tc('NET', 30),
    'I-09-ACB':  _tc('NET', 31),
    # 条件2/3/4 guard 负向用例（同 3E4WY，算法相同）
