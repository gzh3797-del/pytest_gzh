...
from test_case.IOM.operation.IOM_get_attr import get_single_ai_y_measurement, excel_append_ai_measurement, \
...
def iom_test(client: ModbusRtuOrTcp, ai_number=None, ao_number=None, ai_current=None, ai_voltage=None, ao_current=None, ao_voltage=None, expected=None,
    ...
    """
     IOM自动化用例
    :param ai_number: 输入AI通道号,格式为[start, end]
    :param ao_number: 输出AO通道号,格式为[start, end]
    :param client: modbus客户端
    ...
    :param expected: 预期值
    :param write_to_file: 是否写入表格记录：True/False
    :return:
    """
