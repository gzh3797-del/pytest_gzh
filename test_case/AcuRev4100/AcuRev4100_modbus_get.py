...
# print(Power_standard_value_Calculate(100,100,100,15,15,15,0,240,120,270,150,30))
...
def Read_AcuRev4100_Power(Va, Vb, Vc, Ia, Ib, Ic, Va_ang, Vb_ang, Vc_ang, Ia_ang, Ib_ang, Ic_ang, User_Channel):
    ...
    Phase_A_P = Read_Phase_A_Active_Power(Power[0], times=10)
    Phase_A_Q = Read_Phase_A_Reactive_Power(Power[1], times=10)
    Phase_A_S = Read_Phase_A_Apparent_Power(Power[2], times=10)
    Phase_A_PF = Read_Phase_A_Power_Factor(Power[3], times=10)
    ...
    Phase_B_P = Read_Phase_B_Active_Power(Power[4], times=10)
    Phase_B_Q = Read_Phase_B_Reactive_Power(Power[5], times=10)
    Phase_B_S = Read_Phase_B_Apparent_Power(Power[6], times=10)
    Phase_B_PF = Read_Phase_B_Power_Factor(Power[7], times=10)
    ...
    Phase_C_P = Read_Phase_C_Active_Power(Power[8], times=10)
    Phase_C_Q = Read_Phase_C_Reactive_Power(Power[9], times=10)
    Phase_C_S = Read_Phase_C_Apparent_Power(Power[10], times=10)
    Phase_C_PF = Read_Phase_C_Power_Factor(Power[11], times=10)
    ...
    Sys_P = Read_System_Active_Power(Power[12], times=10)
    Sys_Q = Read_System_Reactive_Power(Power[13], times=10)
    Sys_S = Read_System_Apparent_Power(Power[14], times=10)
    Sys_PF = Read_System_Power_Factor(Power[15], times=10)
    ...
    Input1_P = Read_Input_Channel_1_Active_Power(Power[0], times=10)
    Input1_Q = Read_Input_Channel_1_Reactive_Power(Power[1], times=10)
    Input1_S = Read_Input_Channel_1_Apparent_Power(Power[2], times=10)
    Input1_PF = Read_Input_Channel_1_Power_Factor(Power[3], times=10)
    ...
    Input2_P = Read_Input_Channel_2_Active_Power(Power[4], times=10)
    Input2_Q = Read_Input_Channel_2_Reactive_Power(Power[5], times=10)
    Input2_S = Read_Input_Channel_2_Apparent_Power(Power[6], times=10)
    Input2_PF = Read_Input_Channel_2_Power_Factor(Power[7], times=10)
    ...
    Input3_P = Read_Input_Channel_3_Active_Power(Power[8], times=10)
    Input3_Q = Read_Input_Channel_3_Reactive_Power(Power[9], times=10)
    Input3_S = Read_Input_Channel_3_Apparent_Power(Power[10], times=10)
    Input3_PF = Read_Input_Channel_3_Power_Factor(Power[11], times=10)
    ...
    if User_Channel == 'user1,user2,user3':
        User1_P = Read_User_Channel_1_Active_Power(Power[0], times=10)
        User1_Q = Read_User_Channel_1_Reactive_Power(Power[1], times=10)
        User1_S = Read_User_Channel_1_Apparent_Power(Power[2], times=10)
        User1_PF = Read_User_Channel_1_Power_Factor(Power[3], times=10)
        ...
        User2_P = Read_User_Channel_2_Active_Power(Power[4], times=10)
        User2_Q = Read_User_Channel_2_Reactive_Power(Power[5], times=10)
        User2_S = Read_User_Channel_2_Apparent_Power(Power[6], times=10)
        User2_PF = Read_User_Channel_2_Power_Factor(Power[7], times=10)
        ...
        User3_P = Read_User_Channel_3_Active_Power(Power[8], times=10)
        User3_Q = Read_User_Channel_3_Reactive_Power(Power[9], times=10)
        User3_S = Read_User_Channel_3_Apparent_Power(Power[10], times=10)
        User3_PF = Read_User_Channel_3_Power_Factor(Power[11], times=10)
...
def Set_Clear_energy(value):
    ...
    if '(4400,1)' not in str(ret):
        ...
        return False
    # ret = ModbusClient.read_measurement(address=4400, count=1, slave=1)
    # if ret[0] == value:
    #     return True
    return True
...
def Read_Phase_A_Energy():
    ...
    Phase_A_active_energy_net = hex(energy_charge[8]).replace('0x', '').zfill(4) + hex(energy_charge[9]).replace('0x',
                                                                                                                 '').zfill(
    ...
    Phase_A_active_energy_total = hex(energy_charge[12]).replace('0x', '').zfill(4) + hex(energy_charge[13]).replace(
        '0x', '').zfill(
    ...
    Phase_A_reactive_energy_import = hex(energy_charge[16]).replace('0x', '').zfill(4) + hex(energy_charge[17]).replace(
        '0x', '').zfill(
    ...
    Phase_A_reactive_energy_export = hex(energy_charge[20]).replace('0x', '').zfill(4) + hex(energy_charge[21]).replace(
        '0x', '').zfill(
    ...
    Phase_A_reactive_energy_net = hex(energy_charge[24]).replace('0x', '').zfill(4) + hex(energy_charge[25]).replace(
        '0x', '').zfill(
    ...
    Phase_A_reactive_energy_total = hex(energy_charge[28]).replace('0x', '').zfill(4) + hex(energy_charge[29]).replace(
        '0x', '').zfill(
    ...
    Phase_A_Energy_list.extend([Phase_A_active_energy_import, Phase_A_active_energy_export, Phase_A_active_energy_net,
...
def sequence_component_calculation(a: float, b: float, c: float, a_angle: float, b_angle: float, c_angle: float):
    ...
    try:
        VUF_CUF = round((negative_sequence_component / positive_sequence_component), 7)
    except:
        VUF_CUF = 0
    if VUF_CUF > 1:
        VUF_CUF = 1
...
# print(sequence_component_calculation(0,0,0,0,240,120))
