...
FILE_PATH = os.path.join(Path(__file__).parent.parent.parent, "test_case", "AcuDc260", "acudc260_modbus_addrs.xlsx")
OUTPUT_JSON_PATH = os.path.join(Path(__file__).parent.parent.parent, "test_case", "AcuDc260",
                                "acudc260_modbus_addrs.json")
