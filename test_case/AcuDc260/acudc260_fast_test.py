...
from acudc260_modbus_get import HandleMemory
...
from test_case.AcuDc260.acudc260_memory_info import MemoryAddr
from test_case.AcuDc260.acudc260_test_report_table_heading import TableTitle
...
test_case_path = r'./test_case/AcuDc260/acudc260_test_case.xlsx'
sheet_name_dc260 = "test_case_dc260"
...
class PrecisionMeasure:
    ...
    def write_table_title_of_dc260_to_excel(file_path, wb, ws):
        ...
        :return:
        """
        for i in range(len(TableTitle.REAL_TIME_MEASURE_COLUMNS_OF_DC260)):
            j = i + 1
            ws.cell(1, j, f'{TableTitle.REAL_TIME_MEASURE_COLUMNS_OF_DC260[i]}')
        wb.save(file_path)
    ...
    def get_measure_values_of_phase_current(self):
        ...
        i_sum = self.handle_memory.read_i_sum_current()
        return i1, i2, i_sum
    ...
    def get_measure_values_of_power(self):
        ...
        p2 = self.handle_memory.read_p2_power()
        p_sum = self.handle_memory.read_p_sum_power()
        return p1, p2, p_sum
    ...
    def get_measure_values_by_sample_cnt_of_dc260(self, sample_cnt, sample_interval):
        ...
        for j in range(sample_cnt):
            ...
            i1_measure, i2_measure, _ = self.get_measure_values_of_phase_current()
            p1_measure, p2_measure, p_sys_measure = self.get_measure_values_of_power()
            measure_values_of_u.append(u_measure)
            measure_values_of_i1.append(i1_measure)
            measure_values_of_i2.append(i2_measure)
            measure_values_of_p1.append(p1_measure)
            measure_values_of_p2.append(p2_measure)
    ...
    def get_save_filepath_of_dc260(filedir):
        ...
        :return: 待写入文件路径
        """
        filename = f"precision_measure_dc260_{time.strftime('%Y%m%d%H%M%S')}.xlsx"
