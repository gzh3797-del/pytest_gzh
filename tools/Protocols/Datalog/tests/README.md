...
# 错误（sys.path 解析失败）
cd tools/Protocols/Datalog/tests && pytest .
```
...
# 负向用例（D 类，3 条）
pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -m lv4 -v
...
# Logger1 全部 C 类
pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -k "003_01" -v

# Logger2 推送用例
pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -k "003_02_case0" -v

# ── 单条用例 ─────────────────────────────────────────────────

pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -k "TestCase_AcuHMI_003_01_case04" -v
...
pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -v \
  --html=tools/Protocols/Datalog/tests/reports/datalog.html \
  --self-contained-html

# ── 常用选项 ─────────────────────────────────────────────────

# 遇到第一条失败即停止
pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -v -x

# 简短失败原因
pytest tools/Protocols/Datalog/tests/test_datalog_logger.py -v --tb=short
```
