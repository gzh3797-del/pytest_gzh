...
原件：`knowledge/gateway/web2/requirements/raw/接线检测总表_ver1.05.xlsx`（10 个 Sheet）
算法全文摘要：`knowledge/gateway/web2/requirements/summaries/wiring_check_v1.05.md`

> 原件和算法全文由 web2 项目维护，本文件仅做跨项目速查入口，不重复算法内容。
...
| 2e3w1p | 2E3W 1Phase | Va、Vc（2相） | Ia、Ic（2CT） | 1310/2100/IIV3 用 A+B；**AcuVim3/4100/1320 用 A+C** |
...
`knowledge/gateway/web2/requirements/summaries/wiring_check_v1.05.md`
