...
def get_all_ai_y_measurements(modbus_client: ModbusRtuOrTcp, slave_id=modbus_config['rtu']['slaveid']):
    """
    读取所有AI测量值
...
def get_single_ai_y_measurement(ai_number, modbus_client: ModbusRtuOrTcp, slave_id=modbus_config['rtu']['slaveid']) -> float | None:
    """
    读取单个AI输入
...
if __name__ == "__main__":
    ...
    while True:
        ...
        register = get_all_ai_y_measurements(modbus_client)
        print(time_now, register)
